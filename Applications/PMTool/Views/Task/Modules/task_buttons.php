...
<input type="button" data-task-id="<?php echo $_GET['task_id']; ?>" id="btn-from-inactive-task" class="from-inactive-task btn btn-default" value="<?php echo $resx["btn_to_active_list"]; ?>" />
