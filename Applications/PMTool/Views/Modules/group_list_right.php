...
<div class="scroll-bar">
  <ol id="group-list-right" class="list-panel">
    ...
    foreach ($data_right[\Applications\PMTool\Resources\Enums\ViewVariablesKeys::objects_list_right] as $object) {
      if(isset($data_right[\Applications\PMTool\Resources\Enums\ViewVariablesKeys::properties_right][\Applications\PMTool\Resources\Enums\ViewVariablesKeys::data_identifier])) {
        $dataIdentifier =
                  $data_right
