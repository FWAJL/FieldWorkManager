...
<div id="field_analytes"  class="data-form">
<fieldset class="task_field_analytes_form">

                                        <table  style="line-height:40px" width="50%">
                                            <tr>
                                                <td>
                                                    <textarea name="field_multi_analytes" cols="100" rows="7"></textarea></td>
                                            </tr>
                                            <tr>
                                    ...
                                    <span>
                                        ...
                                        <p>Specify units (if needed) as shown.</p>
                                        <p>Like this:</p></span>
                                    Dissolved Oxygen in mg/L<br />
                                    pH<br />
                                    Temperature in oF
