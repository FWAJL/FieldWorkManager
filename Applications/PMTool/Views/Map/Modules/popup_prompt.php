  ...
  <div class="modal-dialog modal-upload">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="prompt_title"><?php echo $resx['location_prompt_title']; ?></h4>
      </div>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-default confirmbuttons" data-dismiss="modal" id="prompt_cancel"><?php echo $resx['location_prompt_cancel']; ?></button>
      </div>
