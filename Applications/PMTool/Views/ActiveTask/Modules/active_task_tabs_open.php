...
<!--    Notes-->
    <li class="tab <?php echo $active_task_tab[Applications\PMTool\Resources\Enums\ActiveTaskTabKeys::ActiveTaskNotesTab]; ?>" data-form-id="active_task_notes">
      <a href="<?php echo __BASEURL__ . \Library\Enums\ResourceKeys\UrlKeys::ActiveTaskNotes . '?task_id=' . $current_task->task_id(); ?>">
        <?php echo $resx["task_tab_notes"]; ?>
      </a>
    </li>  
