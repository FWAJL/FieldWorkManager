...
class Master_form extends \Library\Entity implements \Library\Interfaces\IDocument {
  public
    $form_id,
    $content_type,
    $category,
  ...
  // SETTERS //
  public function setForm_id($master_form_id) {
    $this->form_id = $master_form_id;
  }
