...
ALTER TABLE `field_analyte`
	ADD CONSTRAINT UNIQUE INDEX `un_cfa` (`field_analyte_name_unit` ASC);
ALTER TABLE `lab_analyte`
	ADD CONSTRAINT UNIQUE INDEX `un_cfa` (`lab_analyte_name` ASC);
...
ALTER TABLE `common_lab_analyte`
	ADD CONSTRAINT UNIQUE INDEX `un_cfa` (`common_lab_analyte_name` ASC);
