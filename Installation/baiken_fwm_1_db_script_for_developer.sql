...
CREATE TABLE `baiken_fwm_1`.`location` (
  ...
  `loc_lat` FLOAT(10,6) COLLATE utf8_unicode_ci NOT NULL,
  `loc_long` FLOAT(10,6) COLLATE utf8_unicode_ci NOT NULL,
...
ALTER TABLE `location`
  ADD CONSTRAINT `idlocation_UNIQUE` FOREIGN KEY (`pm_id`) REFERENCES `project` (`project_id`);
